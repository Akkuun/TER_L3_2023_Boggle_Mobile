...
class NativeLibrary {
  ...
  late final _TestGoPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('TestGo');
  late final _TestGo = _TestGoPtr.asFunction<void Function()>();
  ...
  late final _AllWordFromPtr =
      _lookup<ffi.NativeFunction<GoSlice Function(GoSlice, GoSlice)>>(
          'AllWordFrom');
  late final _AllWordFrom =
      _AllWordFromPtr.asFunction<GoSlice Function(GoSlice, GoSlice)>();
